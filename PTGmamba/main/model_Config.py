...
class Config:
    def __init__(self):
        ...
        # 滑动窗口参数
        self.window_size = 20  # 输入长度
        self.pred_steps = 10  # 预测步数
        self.stride = 1  # 滑动步长
        # 训练参数
        self.batch_size = 8
        self.time_split = True
        ...
        self.m_test = f"{self.name_model}_mamba_bs{self.batch_size}_dim{self.d_model}_{self.lr}_{self.epochs}"
